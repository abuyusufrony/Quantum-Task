    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-green-100 to-green-200 flex items-center justify-center p-4">
            <div className="w-full max-w-6xl rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row bg-black relative">
                ...
                {/* Left Side */}
                <div className="w-full md:w-1/2 flex flex-col justify-center items-center px-6 sm:px-10 py-12 bg-gradient-to-br from-black to-green-900 text-white">
                    <div className="w-full max-w-md z-10">
                        {/* Header */}
                        <div className="text-center mb-8">
                            <h2 className="text-2xl sm:text-3xl font-bold mb-2">Login your account</h2>
                            <p className="text-green-300 text-sm">
                                Don’t have an account?{" "}
                                <Link to="/signup" className="underline text-green-400 hover:text-green-300">
                                    Sign Up
                                </Link>
                            </p>
                        </div>
                        ...
                        <p className="mt-6 text-green-300 text-xs text-center leading-relaxed">
                            ...
                            <a href="#" className="underline text-green-400 hover:text-green-300">Terms of Service</a>{" "}
                            and to occasionally receive emails from us. Please read our{" "}
                            <a href="#" className="underline text-green-400 hover:text-green-300">Privacy Policy</a>{" "}
